...
function UpdateBook({Setopenupdate,book}) {
  ...
  const handleSubmit=async(e)=>{
    e.preventDefault();
    try{
      const response =await basepath.patch(`/library/updatebook/${book.id}`,formdata);
    ...
    <>
     <div className="updateBook col-lg-6 col-md-12 flex align-items-center mx-auto">
                <div className="contact-main white-bg p-5  ">
                  ...
                  <button onClick={()=>Setopenupdate(false)} className="updateButton btn btn-outline-danger px-4  "
                 >X</button>
                  </div>
                  
                  <h6 className='text-black'>please fill the fields only you want to update</h6>
