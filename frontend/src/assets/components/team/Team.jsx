    ...
    <div className="row">
      <div className="col-lg-4 col-md-12">
        <div className="team-member text-center style-2">
          ...
          <div className="team-description"> <span>Amir (main)</span>
            <h5><a href="team-single.html">ustaz mensur seid</a></h5> 
      ...
      <div className="col-lg-4 col-md-12 mt-5 mt-lg-0">
        <div className="team-member text-center style-2">
          ...
          <div className="team-description"> <span>Vice Amir</span>
            <h5><a href="team-single.html">mktl Abdurehim</a></h5> 
            <div className="team-social-icon">
              <ul>
                <li><a href="#"><i className="fab fa-facebook-f"></i></a>
                </li>
      ...
      <div className="col-lg-4 col-md-12 mt-5 mt-lg-0">
        <div className="team-member text-center style-2">
          ...
          <div className="team-description"> <span>Secretary</span>
            <h5><a href="team-single.html">Ustaz Nuredin Faruk</a></h5> 
            <div className="team-social-icon">
              <ul>
                <li><a href="#"><i className="fab fa-facebook-f"></i></a>
                </li>
