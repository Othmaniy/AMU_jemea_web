...
!((e, t) => {
	...
	(ce.fn = ce.prototype =
		{
			...
			even: function () {
				return this.pushStack(
					ce.grep(this, (e, t) => (t + 1) % 2),
				);
			},
			odd: function () {
				return this.pushStack(
					ce.grep(this, (e, t) => t % 2),
				);
			},
			eq: function (e) {
				var t = this.length,
	...
	!(() => {
		...
		function V(e) {
			...
			return (
				n != T &&
					...
					(b.find.TAG = (e, t) => "undefined" != typeof t.getElementsByTagName
		...
		(I.contains = (e, t) => ((e.ownerDocument || e) != T && V(e), ce.contains(e, t))),
		(I.attr = (e, t) => {
		...
		((b = ce.expr =
			{
				...
				pseudos: {
					...
					button: (e) => (fe(e, "input") && "button" === e.type) || fe(e, "button"),
					text: (e) => {
						var t;
						return (
							fe(e, "input") &&
		...
		(G.prototype = b.filters = b.pseudos),
			...
			V(),
			(le.sortDetached = $((e) => 1 & e.compareDocumentPosition(T.createElement("fieldset")))),
			(ce.find = I),
		...
		ce.each(
			{
				...
				contents: (e) => null != e.contentDocument && r(e.contentDocument)
						? e.contentDocument
	...
	ce.extend({
		hasData: (e) => X.hasData(e) || _.hasData(e),
		data: (e, t, n) => X.access(e, t, n),
		removeData: (e, t) => {
			X.remove(e, t);
		},
		...
		add: (t, e, n, r, i) => {
			...
			if ($(t)) {
				n.handler && ((n = (o = n).handler), (i = o.selector)),
					...
					(a = v.handle) ||
						(a = v.handle =
							(e) => "undefined" != typeof ce && ce.event.triggered !== e.type
				...
				return (
					(Number.parseFloat(Ge(e, "marginLeft")) ||
						e.getBoundingClientRect().left -
							ze(e, { marginLeft: 0 }, () => e.getBoundingClientRect().left)) + "px"
				);
		})),
	...
	ce.fn.extend({
		...
		(mt = {
			set: (e, t, n) => (!1 === t ? ce.removeAttr(e, n) : e.setAttribute(n, n), n),
		}),
	...
	ce.fn.extend({
		...
		ce.each(["radio", "checkbox"], function () {
			(ce.valHooks[this] = {
				...
				le.checkOn ||
					(ce.valHooks[this].get = (e) => null === e.getAttribute("value") ? "on" : e.value);
		});
	var Et = ie.location,
		jt = { guid: Date.now() },
		At = /\?/;
			...
			(t && !n) ||
				ce.error(
					"Invalid XML: " +
						(n
							? ce
									.map(n.childNodes, (e) => e.textContent)
									.join("\n")
							: e),
				),
			t
				...
				return this.map(function () {
					...
					.map(function (e, t) {
						...
						return null == n
							? null
							: Array.isArray(n)
								? ce.map(n, (e) => ({ name: t.name, value: e.replace(Lt, "\r\n") }))
	...
	(Ut.href = Et.href),
		ce.extend({
			...
			ajaxSetup: (e, t) => t ? Gt(Gt(e, ce.ajaxSettings), t) : Gt(ce.ajaxSettings, e),
			ajaxPrefilter: zt(Bt),
			ajaxTransport: zt(_t),
			ajax: (e, t) => {
		...
		(ce.expr.pseudos.visible = (e) => !!(e.offsetWidth || e.offsetHeight || e.getClientRects().length)),
		(ce.ajaxSettings.xhr = () => {
			try {
	...
	ce.ajaxSetup({
		...
		ce.ajaxPrefilter("json jsonp", (e, t, n) => {
			...
			if (a || "jsonp" === e.dataTypes[0])
				return (
					...
					(e.converters["script json"] = () => (o || ce.error(r + " was not called"), o[0])),
					(e.dataTypes[0] = "json"),
					(i = ie[r]),
					(ie[r] = () => {
						o = arguments;
		...
		(ce.parseHTML = (e, t, n) => "string" != typeof e
				? []
		...
		(ce.expr.pseudos.animated = (t) => ce.grep(ce.timers, (e) => t === e.elem).length),
		(ce.offset = {
			setOffset: (e, t, n) => {
				var r,
					i,
...
!((t, e) => {
	...
	var zt = "top",
		...
		ee = [].concat(Qt, [Kt]).reduce((t, e) => t.concat([e, e + "-" + Xt, e + "-" + Yt]), []),
		ie = "beforeRead",
		ne = "read",
		se = "afterRead",
		oe = "beforeMain",
					...
					var s = i.mainAxis,
						...
						b =
							...
							(_ !== g && p
								...
								: [Ve(g)]),
						v = [g].concat(b).reduce((t, i) => t.concat(
								be(i) === Kt
									? ni(e, {
											placement: i,
											boundary: h,
...
!((n, e, s) => {
	function o(n) {
		...
		Modernizr._config.enableClasses &&
			((e += " " + s + n.join(" " + s)),
			c ? (f.className.baseVal = e) : (f.className = e));
	}
	function a(n, e) {
		return typeof n === e;
	}
	...
	i(), o(t), delete r.addTest, delete r.addAsyncTest;
