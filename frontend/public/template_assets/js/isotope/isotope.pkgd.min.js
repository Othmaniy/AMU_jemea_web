...
!((a) => {
	...
	function () {
		...
		(d.getListeners = function (a) {
			...
			(a.noConflict = () => ((this.EventEmitter = f), a)),
			"function" == typeof define && define.amd
				? define("eventEmitter/EventEmitter", [], () => a)
	...
	((a) => {
		...
		"function" == typeof define && define.amd
			? define("get-style-property/get-style-property", [], () => b)
			: "object" == typeof exports
				? (module.exports = b)
	...
	((a) => {
		...
		"function" == typeof define && define.amd
			? define("matches-selector/matches-selector", [], () => f)
			: "object" == typeof exports
				? (module.exports = f)
	...
	((a, b) => {
		...
		(d.extend = (a, b) => {
			...
			(d.modulo = (a, b) => ((a % b) + b) % b);
		var e = Object.prototype.toString;
		(d.isArray = (a) => "[object Array]" == e.call(a)),
			(d.makeArray = (a) => {
				var b = [];
				if (d.isArray(a)) b = a;
			...
			(d.getQueryElement = (a) => "string" == typeof a ? document.querySelector(a) : a),
			(d.handleEvent = function (a) {
				var b = "on" + a.type;
				this[b] && this[b](a);
			}),
			(d.filterFindElements = (a, b) => {
				a = d.makeArray(a);
			...
			(d.debounceMethod = (a, b, c) => {
				...
				a.prototype[b] = function () {
					...
					var b = arguments;
					this[e] = setTimeout(() => {
						d.apply(this, b), delete this[e];
					}, c || 100);
				};
			}),
			(d.toDashed = (a) => a
					.replace(/(.)([A-Z])/g, (a, b, c) => b + "-" + c)
					.toLowerCase());
		var f = a.console;
		return (
			(d.htmlInit = (c, e) => {
	...
	((a, b) => {
		...
		e.extend(g.prototype, b.prototype),
			...
			(g.prototype.getPosition = function () {
				var a = j(this.element),
					...
					h =
						-1 != e.indexOf("%")
							? (Number.parseFloat(e) / 100) * g.width
							: Number.parseInt(e, 10),
					i =
						-1 != f.indexOf("%")
							? (Number.parseFloat(f) / 100) * g.height
			...
			(g.prototype._transitionTo = function (a, b) {
				...
				var c = this.position.x,
					d = this.position.y,
					e = Number.parseInt(a, 10),
					f = Number.parseInt(b, 10),
			...
			(g.prototype.setPosition = function (a, b) {
				(this.position.x = Number.parseInt(a, 10)),
					(this.position.y = Number.parseInt(b, 10));
			}),
		...
		return (
			...
			(g.prototype.remove = function () {
				if (!k || !Number.parseFloat(this.layout.options.transitionDuration))
	...
	((a, b) => {
		...
		return (
			...
			(g.prototype._getItemsForLayout = (a) => {
			...
			(g.prototype._getItemLayoutPosition = () => ({ x: 0, y: 0 })),
			...
			(g.prototype._positionItem = (a, b, c, d) => {
			...
			(g.prototype._emitCompleteOnItems = (a, b) => {
				function c() {
	...
	((a, b) => {
		...
		(m.Item = f),
			...
			(m.prototype._updateItemsSortData = (a) => {
				for (var b = a && a.length, c = 0; b && b > c; c++) {
					var d = a[c];
					d.updateSortData();
				}
